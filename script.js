...
for (i = 0; i < description.length; i++) {
    let showDescription = description[i]
    showDescription.addEventListener('mouseenter', () => {
        showDescription.classList.toggle("show")
    })
}
